...
FROM ghcr.io/actions-runner-controller/actions-runner-controller/actions-runner:v2.313.0-ubuntu-22.04
...
COPY --from=eclipse-temurin:17.0.10_7-jdk-jammy $JAVA_HOME $JAVA_HOME

...
printf '%s\n' "scan.uploadInBackground=false" "org.gradle.console=plain" "org.gradle.workers.max=1" "org.gradle.daemon=false" "org.gradle.configuration-cache=true" >/home/runner/.gradle/gradle.properties
